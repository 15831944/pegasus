...
{
    [TestClass]
    public class EditUserLimitCorp : DriverTestCase
    {
        [TestMethod]
        [TestCategory("All")]
        ...
        public void editUserLimitCorp()
        {
            ...
            try
            {
                ...
                executionLog.Log("EditUserLimitCorp", "Click Edit User Limit");
                corpMasterdata_UserLimitsHelper.ClickElement("EditUserLimt");

                executionLog.Log("EditUserLimitCorp", "Enter Employee Limit");
                corpMasterdata_UserLimitsHelper.TypeText("EmployeeLimit", "15");

                executionLog.Log("EditUserLimitCorp", "Enter SaleAgent limit");
                corpMasterdata_UserLimitsHelper.TypeText("Sale1099Agent", "15");

                executionLog.Log("EditUserLimitCorp", "Enter lient User limit");
                ...
                executionLog.Log("EditUserLimitCorp", "Click on save button.");
            ...
            catch (Exception e)
            {
                ...
                if (!result)
                {
                    if (Int16.Parse(counter) < 9)
                    {
                        ...
                        loginHelper.CreateIssue("Edit User Limit Corp", "Bug", "Medium", "User limit page", "QA", "Log in as: " + username[0] + " / " + password[0] + "\n\nSteps:\n" + Description + "\n\n\nError Description:\n" + Error);
