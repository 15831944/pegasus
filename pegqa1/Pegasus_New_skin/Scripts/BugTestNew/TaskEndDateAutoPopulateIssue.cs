...
{
    [TestClass]
    public class TaskEndDateAutoPopulateIssue : DriverTestCase
    {
        [TestMethod]
        [TestCategory("All")]
        [TestCategory("Admin")]
        ...
        public void taskEndDateAutoPopulateIssue()
        {
            ...
            try
            {
                ...
                officeActivities_TasksHelper.TypeText("StartDate", "11/17/2016");
                officeActivities_TasksHelper.WaitForWorkAround(4000);

                executionLog.Log("TaskEndDateAutoPopulateIssue", "Enter task Due date");
                officeActivities_TasksHelper.TypeText("DueDate", "12/17/2016");
                ...
                officeActivities_TasksHelper.WaitForText("Task saved successfully.", 30);
                ...
                executionLog.Log("TaskEndDateAutoPopulateIssue", "Select All in owner field");
                ...
                officeActivities_TasksHelper.WaitForWorkAround(6000);

                executionLog.Log("TaskEndDateAutoPopulateIssue", "Verify task end date is filled.");
                officeActivities_TasksHelper.VerifyPageText("2016-12-17");
                ...
                officeActivities_TasksHelper.WaitForText("Task Updated Success.", 20);
                ...
                officeActivities_TasksHelper.WaitForText("Task deleted successfully", 40);
