...
{
    public class MyProfilePageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public MyProfilePageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("MyProfilePage.xml");
        }
