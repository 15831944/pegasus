...
{
    public class CorpSystem_SettingsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CorpSystem_SettingsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CorpSystem_Settings.xml");
        }
