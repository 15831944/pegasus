...
{
    public class System_EmailTemplatesHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public System_EmailTemplatesHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("System_EmailTemplates.xml");
        }
