...
{
    public class OfficeTickets_AllTicketsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OfficeTickets_AllTicketsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OfficeTickets_AllTickets.xml");
        }
