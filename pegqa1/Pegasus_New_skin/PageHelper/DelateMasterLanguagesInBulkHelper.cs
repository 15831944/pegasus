...
{
    public class DelateMasterLanguagesInBulkHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public DelateMasterLanguagesInBulkHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("DelateMasterLanguagesInBulk.xml");
        }
