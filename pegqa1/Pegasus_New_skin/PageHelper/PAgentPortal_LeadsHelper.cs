...
{
    public class PAgentPortal_LeadsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public PAgentPortal_LeadsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("PAgentPortal_Leads.xml");
        }
