...
{
    public class VerifySelectedUserGroupHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public  VerifySelectedUserGroupHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("VerifySelectedUserGroup.xml");
        }
        ...
        public void VerifyDuplicateBtn(string xmlonode,string savexml)
        {
            String locator = locatorReader.ReadLocator(xmlonode);
            String locator1 = locatorReader.ReadLocator(savexml);
