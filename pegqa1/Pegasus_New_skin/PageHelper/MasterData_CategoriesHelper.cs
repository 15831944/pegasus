...
{
    public class MasterData_CategoriesHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public MasterData_CategoriesHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("MasterData_Categories.xml");
        }
