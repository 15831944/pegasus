...
{
    public class MasterData_ProcessorsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public MasterData_ProcessorsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("MasterData_Processors.xml");
        }
