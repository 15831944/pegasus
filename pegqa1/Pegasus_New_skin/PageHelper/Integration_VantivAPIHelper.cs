...
{
    public class Integration_VantiveAPIHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public Integration_VantiveAPIHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("Integration_VantivAPI.xml");
        }
