...
{
    public class AddressTypeProfilePageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public AddressTypeProfilePageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("AddressTypeProfilePage.xml");
        }
