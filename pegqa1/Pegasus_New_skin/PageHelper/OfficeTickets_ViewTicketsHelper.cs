...
{
    public class OfficeTickets_ViewTicketsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public OfficeTickets_ViewTicketsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("OfficeTickets_ViewTickets.xml");
        }
