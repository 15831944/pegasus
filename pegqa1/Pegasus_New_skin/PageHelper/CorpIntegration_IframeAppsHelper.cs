...
{
    public class CorpIntegration_IframeAppsHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CorpIntegration_IframeAppsHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CorpIntegrations_IframeApps.xml");
        }
        ...
        // Force filly click on any element
