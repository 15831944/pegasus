...
{
    public class CorpSystem_ThemesHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CorpSystem_ThemesHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CorpSystem_Themes.xml");
        }
