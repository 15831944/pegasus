...
{
    public class CorpSystem_EmailTemplatesHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CorpSystem_EmailTemplatesHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CorpSystem_EmailTemplates.xml");
        }
