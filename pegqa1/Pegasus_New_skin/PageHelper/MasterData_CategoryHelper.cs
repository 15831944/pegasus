...
{
    public class MasterData_CategoryHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public MasterData_CategoryHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("MasterData_Category.xml");
        }
